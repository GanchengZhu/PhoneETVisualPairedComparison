...
public class CalculatorUtils {
    ...
    public static double conversion(String expression) {
        ...
        if ("-0".equals(expression) || "0".equals(expression) || "+0".equals(expression) ) return 0;
        try{
    ...
    public double calculate(String expression) {
        ...
        while (!postfixStack.isEmpty()) {
            ...
            if (!isOperator(currentValue.charAt(0))) {// 如果不是运算符则存入操作数栈中
                ...
                currentValue = piCovert(currentValue);
                ...
                firstValue = piCovert(firstValue);
                secondValue = piCovert(secondValue);
    ...
    private String piCovert(String value){
        if ("π".equals(value) || "PI".equals(value) || "pi".equals(value)){
            return String.valueOf(Math.PI);
        }
        else if ("-π".equals(value) || "-PI".equals(value) || "-pi".equals(value)){
            return String.valueOf(-Math.PI);
        }else return value;
    }
}
